<div id="heSlaveGroup" data-action="{$slave_group_action}">
	<div class="component">
		...
		<div class="element" data-name="sex">
			...
			<div class="control"><select id="sex" data-validation-profile="5eaac4f83b67e"
										 class="input_element">
		...
		<div class="element" data-name="age_group">
			...
			<div class="control"><select id="age_group" data-validation-profile="5eaac4f83b67e"
										 class="input_element">
		...
		<div class="element" data-name="quantity">
			...
			<div class="control"><input type="text" size="30" data-reset-value="line" value="" id="amount"
		...
		<div class="element" data-name="slaves_total_female">
			...
			<div class="control"><input type="text" size="20" data-reset-value="line" value="" id="amount_standardized"
										data-validation-profile="5e823fa99b83a" class="input_element">
				<div id="errorMsg_5e823fa99b83a" class="errorMsg"></div>
			</div>
		</div>
